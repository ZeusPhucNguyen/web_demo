document.addEventListener("DOMContentLoaded",function(){
    var itemAppear =  document.getElementsByClassName('nav-link');
    for (var i = 0; i<itemAppear.length; i++){
        itemAppear[i].onclick = function (){
            // console.log(this.getAttribute('data-menu'));
            var ndlist = this.getAttribute('data-menu');
            var item = document.getElementById(ndlist);
            for(var i =0; i<itemAppear.length;i++){
                itemAppear[i].classList.add('item-insert');
            }
